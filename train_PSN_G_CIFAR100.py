    ...
    def __init__(self, channels, T):
        ...
        for i in range(2):
            for j in range(3):
                ...
                conv.append(neuron.PSN_G(T=T,surrogate_function=surrogate.ATan()))
        ...
        self.fc = nn.Sequential(
            ...
            neuron.PSN_G(T=T,surrogate_function=surrogate.ATan()),
...
def main():
    ...
    '''
    python train_PSN_G_CIFAR100.py -data-dir ./datasets/CIFAR100 -amp -opt sgd -channels 128 -epochs 128
    ...
    out_dir = f'CIFAR100_PSN_G_T_{args.T}_e{args.epochs}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}'
    if args.amp:
        out_dir += '_amp'
