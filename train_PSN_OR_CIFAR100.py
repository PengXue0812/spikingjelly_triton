...
def main():
    ...
    '''
    python train_PSN_OR_CIFAR100.py -data-dir ./datasets/CIFAR100 -amp -opt sgd -channels 128 -epochs 128
    ...
    out_dir = f'CIFAR100_PSN_OR_T_{args.T}_e{args.epochs}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}'
    if args.amp:
        out_dir += '_amp'
