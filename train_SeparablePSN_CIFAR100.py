...
class CIFAR100Net(nn.Module):
    def __init__(self, channels, T: int, P: int):
        super().__init__()
        self.T = T
        self.P = P
        conv = []
...
def main():
    ...
    '''
    python train_SeparablePSN_CIFAR100.py -data-dir ./datasets/CIFAR100 -amp -opt sgd -channels 128 -epochs 128 -T 4 -P 1 -device cuda:1
    '''
    ...
    out_dir = f'CIFAR100_T{args.T}_P{args.P}PSN_e{args.epochs}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}'
    if args.amp:
        out_dir += '_amp'
    ...
    net = CIFAR100Net(args.channels, T=args.T, P=args.P)
    net.to(args.device)
