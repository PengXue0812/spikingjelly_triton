    ...
    def __init__(self, channels, T: int, class_num: int, P:int=-1):
        ...
        for i in range(2):
            for j in range(3):
                ...
                conv.append(custom_module.SpearablePSN(T=T, P=P, surrogate_function=surrogate.ATan()))
        ...
        self.fc = nn.Sequential(
            ...
            custom_module.SpearablePSN(T, P, surrogate_function=surrogate.ATan()),
...
def main():
    '''
        python train_SeparablePSN_secf10.py -data-dir ./datasets/CIFAR10 -amp -opt sgd -channels 128 -epochs 128 -P 1 -device cuda:0
    '''
    ...
    out_dir = f'secf10_T_{args.T}P_{args.P}SeparablePSNe{args.epochs}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}'
    if args.amp:
        out_dir += '_amp'
