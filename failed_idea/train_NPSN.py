    ...
    def __init__(self, channels, T, tau):
        ...
        for i in range(2):
            for j in range(3):
                ...
                conv.append(neuron.N_PSN(T, tau, surrogate_function=surrogate.ATan()))
...
def main():
    ...
    '''
    python train_NPSN.py -data-dir /datasets/CIFAR10 -amp -opt sgd -channels 128 -epochs 256;
    ...
    out_dir = f'PSN_OR_T_{args.T}_tau{args.tau}_e{args.epochs}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}'
    if args.amp:
        out_dir += '_amp'
