    ...
    def __init__(self, channels, T, tau):
        ...
        for i in range(2):
            for j in range(3):
                ...
                conv.append(neuron.ParameterPSN(tau=tau, T=T, surrogate_function=surrogate.ATan()))
        ...
        self.fc = nn.Sequential(
            ...
            neuron.ParameterPSN(tau=tau, T=T, surrogate_function=surrogate.ATan()),
...
def main():
    ...
    '''
    python train_ParameterPSN_CIFAR100.py -data-dir ./datasets/CIFAR100 -amp -opt sgd -channels 128 -epochs 128 -tau 1
    ...
    out_dir = f'CIFAR100_ParameterPSN_G_T_{args.T}_e{args.epochs}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}_tau{args.tau}'
    if args.amp:
        out_dir += '_amp'
    ...
    net = CIFAR100Net(args.channels, args.T, args.tau)
    net.to(args.device)
