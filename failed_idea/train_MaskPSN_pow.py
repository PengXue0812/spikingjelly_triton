...
def main():
    '''
        python train_MaskPSN_pow.py -data-dir ./datasets/CIFAR10 -amp -opt sgd -channels 128 -epochs 256 -P 32  -device cuda:4
    '''
    ...
    out_dir = f'secf10_T_{args.T}P_{args.P}MaskedPSN_x^1_e{args.epochs}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}'
