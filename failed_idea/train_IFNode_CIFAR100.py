    ...
    def __init__(self, channels):
        ...
        for i in range(2):
            for j in range(3):
                ...
                conv.append(neuron.IFNode(surrogate_function=surrogate.ATan(), detach_reset=True, step_mode='m', backend='cupy'))
        ...
        self.fc = nn.Sequential(
            ...
            neuron.IFNode(surrogate_function=surrogate.ATan(), detach_reset=True, step_mode='m', backend='cupy'), 
...
def main():
    ...
    '''
    python train_IFNode_CIFAR100.py -data-dir ./datasets/CIFAR100 -amp -opt sgd -channels 128 -epochs 128
    ...
    out_dir = f'CIFAR100_IF_T_{args.T}_e{args.epochs}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}'
    if args.amp:
        out_dir += '_amp'
