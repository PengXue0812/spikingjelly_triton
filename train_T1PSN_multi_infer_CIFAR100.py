...
def main():
    ...
    '''
    python train_T1PSN_multi_infer_CIFAR100.py -data-dir ./datasets/CIFAR100 -amp -opt sgd -channels 128 -epochs 128 -T 4 -device cuda:1
    '''
    ...
    out_dir = f'CIFAR100_T1PSN_multi_predict_T_{args.T}e{args.epochs}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}'
    if args.amp:
        out_dir += '_amp'
